...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $login_check = $class->login_admin($user_admin, $pass_admin); // hàm check User and Pass khi submit lên
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6" style="background-image: url(img/forgot.jpg);"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input name="user_admin" type="text" class="form-control form-control-user" placeholder="Nhập tên tài khoản...">
                                        </div>
                                        <div class="form-group">
                                            <input name="pass_admin" type="password" class="form-control form-control-user" placeholder="Nhập mật khẩu">
                                        </div>
